		...
		<div className="flex flex-col items-center pb-20">
			...
			<div className="flex justify-center w-full items-center mt-24">
				<div className="flex justify-center">
					<div className="w-[31.5%] flex flex-col gap-10">
						<div className="mt-5">
							<h1
					...
					<div className=" drop-shadow-[0_5px_5px_rgba(0,0,0,0.08)] ">
						<Image
			...
			<div className="flex justify-center w-full items-center mt-20">
				<div className="flex justify-center gap-4">
					...
					<div className="w-[31.5%] flex flex-col gap-6 mt-14">
						<h1
							className="text-transparent bg-clip-text 
                    bg-gradient-to-r from-[#39b54a] to-[#ABD27B] text-xl font-[Nohemi-ExtraBold]"
						>
			...
			<section className="bg-[#F7FBEF] py-10 px-6 lg:px-20 w-11/12">
				<div className="flex justify-center items-center">
					<div className="text-center w-8/12 flex flex-col gap-4">
				...
				<div className="flex mt-14 w-full gap-10">
					<div className="w-8/12 mx-auto bg-[#F6FBE9] border-[0.5px] border-[#E5F5BD] text-sm rounded p-10">
						{faqs.map((faq, index) => (
							<div
								key={index}
							...
							>
								<button
									className="w-full text-left flex justify-between font-medium items-center py-4 text-gray-800 focus:outline-none"
								...
								{openIndex === index && faq.answer && (
									<p className="text-gray-600 text-xs pr-32 pb-4">
										{faq.answer}
									</p>
								)}
							</div>
					...
					{/* Ask a Question Box */}
					<div className="p-6 text-center bg-[#F6FBE9] border-[0.5px] border-[#E5F5BD] rounded h-72 flex flex-col gap-6 justify-center items-center w-4/12 mx-auto">
